...
|이동 속도|moveSpeed|집게 외계 종족 일반 오브젝트의 체력||
|돌진 속도|dashSpeed|집게 외계 종족 일반 오브젝트의 체력||
|공격력|ac_Damage|집게 외계 종족 일반 오브젝트의 체력||
|공격 사거리|attck_dis|집게 외계 종족 일반 오브젝트의 체력||

### 3) 오브젝트 : 집게 외계 종족 강화
|속성|영문명칭|설명|비고|
|:----:|:----:|:----:|:----:|
|체력|cm_HP|집게 외계 종족 강화 오브젝트의 체력||
|이동 속도|moveSpeed|집게 외계 종족 강화 오브젝트의 체력||
|돌진 속도|dashSpeed|집게 외계 종족 강화 오브젝트의 체력||
|공격력|cm_Damage|집게 외계 종족 강화 오브젝트의 체력||
|공격 사거리|attck_dis|집게 외계 종족 강화 오브젝트의 체력||

### 4) 오브젝트 : 외계 돌연변이
|속성|영문명칭|설명|비고|
|:----:|:----:|:----:|:----:|
|체력|am_HP|외계 돌연변이 오브젝트의 체력||
|이동 속도|moveSpeed|외계 돌연변이 오브젝트의 체력||
|돌진 속도|dashSpeed|외계 돌연변이 오브젝트의 체력||
|공격력|am_Damage|외계 돌연변이 오브젝트의 체력||
|공격 사거리|attck_dis|외계 돌연변이 오브젝트의 체력||

### 5) 오브젝트 : 인간 숙주 돌연변이
|속성|영문명칭|설명|비고|
|:----:|:----:|:----:|:----:|
|체력|sm_HP|인간 숙주 돌연변이 오브젝트의 체력||
|이동 속도|moveSpeed|인간 숙주 돌연변이 오브젝트의 체력||
|돌진 속도|dashSpeed|인간 숙주 돌연변이 오브젝트의 체력||
|공격력|sm_Damage|인간 숙주 돌연변이 오브젝트의 체력||
|공격 사거리|attck_dis|인간 숙주 돌연변이 오브젝트의 체력||

### 6) 오브젝트 : 렙틸리언
|속성|영문명칭|설명|비고|
|:----:|:----:|:----:|:----:|
|체력|re_HP|렙틸리언 오브젝트의 체력||
|이동 속도|moveSpeed|렙틸리언 오브젝트의 체력||
|돌진 속도|dashSpeed|렙틸리언 오브젝트의 체력||
|공격력|re_Damage|렙틸리언 오브젝트의 체력||
|공격 사거리|attck_dis|렙틸리언 오브젝트의 체력||

### 7) 오브젝트 : 타이탄알파
|속성|영문명칭|설명|비고|
|:----:|:----:|:----:|:----:|
|체력|ta_HP|타이탄알파 오브젝트의 체력||
|이동 속도|moveSpeed|타이탄알파 오브젝트의 체력||
|돌진 속도|dashSpeed|타이탄알파 오브젝트의 체력||
|공격력|ta_Damage|타이탄알파 오브젝트의 체력||
|공격 사거리|attck_dis|타이탄알파 오브젝트의 체력||
